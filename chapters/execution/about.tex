...
The license field uses the included \tfcode{LICENSE} file as input, which includes the full text of the \emph{GNU General Public License Version 3} \cite{GPLv3}. 
