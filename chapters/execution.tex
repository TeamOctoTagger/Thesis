...
\subsubsection{PIL}
Python Imaging Library. % TODO expand on this

\subsubsection{Management tools}
Taiga, Toggl, Trello, Punchtime. % TODO expand on this
...
\Cref{lst:db:system} shows the entire schema. When the program is started for
...
recorded in intermediate tables. \Cref{lst:db:gallery} shows the entire schema.
