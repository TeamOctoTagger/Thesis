...
% FIXME overfull hbox in tfcode

The \tfcode{ItemView} class extends from \tfcode{ScrolledWindow} and
...
(\tfcode{wx.ALIGN\_CENTER\_HORIZONTAL}) and cut off with an ellipsis if it
doesn't fit in the provided horizontal space (\tfcode{wx.ST\_NO\_AUTORESIZE |
wx.ST\_ELLIPSIZE\_END}).

% TODO ThumbnailThread
